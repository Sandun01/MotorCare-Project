...
<div class="container">
<form action="AddPaymnetDetails" method="post">
  	<div class= "title">
    ...
    <div class="col-75">
	<input type="text" id="pNo" name="pNo" placeholder="07# #######">
    </div>
  	</div>
  	<div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <select id="Year" name = "year">
    	...
    	<div class="col-75">
      	<input type="text" id="Add1" name="Add1" placeholder="Address1">
    	</div>
  		</div>
  		<br>
    	<div class="row">
    	...
    	<div class="col-75">
      	<input type="text" id="Add2" name="Add2" placeholder="Address2">
    	</div>
  		</div>
    	<div class="row">
    	<div class="col-25">
